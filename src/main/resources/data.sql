...
DROP TABLE ASSIGN_PERMISSION_TO_ROLE IF EXISTS CASCADE;
DROP TABLE ASSIGN_USER_TO_ROLE IF EXISTS CASCADE;

CREATE TABLE PERMISSION (ID INT PRIMARY KEY AUTO_INCREMENT, PERMISSION_NAME VARCHAR(20));

CREATE TABLE USER (ID INT PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(20), EMAIL_ID VARCHAR(255) UNIQUE, PASSWORD VARCHAR(1000));
--
...
INSERT INTO PERMISSION (ID, PERMISSION_NAME) VALUES (1, 'CREATE_PAYMENT'), (2, 'EDIT_PAYMENT'), (3, 'DELETE_PAYMENT'), (4, 'VIEW_ALL_PAYMENT'), (5, 'VIEW_PAYMENT');

INSERT INTO ROLE (ID, ROLE_NAME) VALUES (1, 'ADMINISTRATOR'), (2, 'AUDITOR');

INSERT INTO USER (ID, NAME, EMAIL_ID, PASSWORD) VALUES (1, 'user1', 'user1@gmail.com','$2a$10$jbIi/RIYNm5xAW9M7IaE5.WPw6BZgD8wcpkZUg0jm8RHPtdfDcMgm');
INSERT INTO USER (ID, NAME, EMAIL_ID, PASSWORD) VALUES (2, 'user2', 'user2@gmail.com','$2a$10$jbIi/RIYNm5xAW9M7IaE5.WPw6BZgD8wcpkZUg0jm8RHPtdfDcMgm');
